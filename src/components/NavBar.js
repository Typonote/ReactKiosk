...
const NavBar = () => {
    return (
        <div className="grid grid-cols-3 text-center">
            ...
            <Link to='/order/coffee' className='py-5 cursor-pointer hover:bg-yellow-200 border-r-2 border-b-2 border-white'>
                <img className="h-15 ml-auto mr-auto mb-3" src={coffee} alt="cocktail" />
                <p className='text-white font-mono font-black text-xl'>커피</p>
            </Link>

            <Link to='/order/wine' className='py-5 cursor-pointer hover:bg-yellow-200 border-b-2 border-white'>
